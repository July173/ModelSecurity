...
namespace Business
{
    ...
    public class AprendizProgramBusiness
    {
        ...
        private readonly ILogger<AprendizProgramData> _logger;

        public AprendizProgramBusiness(AprendizProgramData aprendizProgramData, ILogger<AprendizProgramData> logger)
        {
